...
import 'package:flutter/material.dart';
import 'package:flutter_application_newproject/Constant/app-colors.dart';
import 'package:flutter_application_newproject/View/Clock/end_time.dart';

class FullScreenTimePicker extends StatefulWidget {
  const FullScreenTimePicker({super.key});
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: TextField(
                            ...
                            controller: TextEditingController(
                              text: selectedTime.hourOfPeriod
                                  .toString()
                                  .padLeft(2, '0'),
                            ),
                            onChanged: (val) {
                        ...
                        SizedBox(
                          ...
                          child: TextField(
                            ...
                            onChanged: (val) {
                              int min =
                                  int.tryParse(val) ?? selectedTime.minute;
                              if (min >= 0 && min <= 59) {
                                _updateTime(
                                  TimeOfDay(
